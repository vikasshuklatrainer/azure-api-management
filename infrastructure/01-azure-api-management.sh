...
az apim create -n $APIM_NAME -g $RG_NAME -l $AZ_REGION --publisher-name "Vikas Shukla  AG" --publisher-email vikasshuklatrainer@gmail.com --sku-name Developer --sku-capacity 1 --tags app='Azure API Management Sample'